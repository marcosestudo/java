...
public class Program {
	...
	public static void main(String[] args) throws ParseException {
		...
		Date x3 = new Date(0L); // data inicial de quando o Java começou a contar os milissegundos para gerar as datas
		Date x4 = new Date(1000L * 60L * 60L * 5L); // Criando uma data a partir dos milissegundos
		// No exemplo acima queríamos 5 horas a partir do início da contagem em 1970
		...
		// abaixo (y3) temos o formato ISO 8601, coostuma ser o padrão para se guardar datas
		...
		// Por padrão, guardamos as datas em formato UTC e convertemos para nossa timezone quando vamos usá-la
		Date y3 = Date.from(Instant.parse("2018-06-25T15:42:07Z"));
		
		// Por padrão, aas datas são impressas na timezone do computador
		// para mimprimirmos no formato UTC / GMT, devemos especificar como no sdf3 (linha 18)
		// Abaixo temoa a impressão de data padrão do Java, sem estar formatada com o SimpleDateFormat()
		...
		// Nossa timezone é GMT -3
		// As datas abaixo estarão 3 horas adiantadas em relação à nossa
