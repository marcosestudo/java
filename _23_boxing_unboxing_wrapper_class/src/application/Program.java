...
public class Program {
	...
	public static void main(String[] args) {
		...
		// informação por poderem ser iniciadas como null (tipos primitivos não aceitam
		// o valor null) e por usufruirem dos recursos de orientação à objetos
		// Em bancos de dados é comum termos campos opcionais que, quando não
		// preenchidos, são iniciados como null
